...
class TrainingHistogramPlotter:
    ...
    def plot_ROC(self) -> None:
        ...
        for sclass in tqdm(range(score_classes), desc="Plotting ROC curves"):
            ...
            tpcut = np.load('tpr2022-02-07_21-02-46.npy')
            tpcut1 = np.load('tprw2022-02-07_21-02-46.npy')
            fpcut = np.load('fpr2022-02-07_21-02-46.npy')
            fpcut1 = np.load('fprw2022-02-07_21-02-46.npy')
            ay= plt.figure()
            r =tpr[0][0:1000]/tpcut1[0:1000]
            plt.plot(fpcut1[100:1000],r[100:])
